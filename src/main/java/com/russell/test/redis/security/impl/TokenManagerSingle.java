...
public class TokenManagerSingle implements TokenManager {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TokenManagerSingle.class);
    ...
    public TokenInfo createNewToken(UserDetails userDetails) {
        ...
        if (previous != null) {
            logger.warn(" *** SERIOUS PROBLEM HERE - we generated the same token (randomly?)!");
            return null;
        }
